...
const config: NuxtConfig = {
  ...
  */
  ...
  components: [
    ...
    '~/components/events',
    '~/components/events/summer-school',
    '~/components/global',
    '~/components/landing/TheHeroMoment',
    '~/components/landing/TheLearnSection',
    '~/components/landing/TheQuickStart',
    '~/components/layouts/PageFooter',
