...
const headerDescription = ['Most gate-based quantum computers share similar challenges with noise and errors. These pages explore how errors affect quantum circuits, and how we can mitigate them, without worrying about the physics of the device itself.']

const headerImg = '/images/learn/course/quantum-hardware-circuits/quantum-hardware-circuits.png'
