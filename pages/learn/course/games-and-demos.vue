...
// const headerDescription = ["Qiskit, and the Qiskit Textbook website, are interactive learning environments. Unlike with traditional, ink-and-paper textbooks, you can mess around with quantum effects to strengthen your knowledge. These pages contain cool experiments with Qiskit that don't belong in a course."]
...
//     segment: { cta: 'level-5-proving-uniqueness-of-quantum-variables', location: 'course' },
...
//     segment: { cta: 'estimating-pi-using-quantum-phase-estimation-algorithm', location: 'course' },
...
//     segment: { cta: 'local-reality-and-the-chsh-inequality', location: 'course' },
...
// export default class GamesAndDemosPage extends CourseOverviewPage {
