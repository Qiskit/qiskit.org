    ...
    <header class="the-learn-header">
      <div class="the-learn-header__container">
        <h1 class="the-learn-header__title">
          A Carefully Worded Summary of<br>
          Quantum Computing for
          <span class="the-learn-header__relevant-word">Advanced</span>
        </h1>
      </div>
    </header>
...
@Component({
  ...
  head () {
    return {
      title: 'Qiskit Learn - A Carefully Worded Summary of Quantum Computing for Advanced'
    }
  }
})

export default class extends QiskitPage {
  routeName = 'learn-summary-advanced'
}
</script>
