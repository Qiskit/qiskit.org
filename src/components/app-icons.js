...
export const mediumIcon = html`
  <svg
    ...
    role="img"
  >
    <title id="medium-icon">Medium icon</title>
    <path
...
`;
export const pythonIcon = html`
  <svg
    viewBox="0 0 24 24"
    width="24"
    height="24"
    aria-labelledby="python-icon"
    role="img"
  >
    <title id="python-icon">Python icon</title>
    <path
...
export const slackIcon = html`
  <svg
    ...
    role="img"
  >
    <title id="slack-icon">Slack icon</title>
    <path
...
`;
export const stackexchangeIcon = html`
  <svg
    viewBox="0 0 24 24"
    width="24"
    height="24"
    ...
    role="img"
  >
    <title id="stackexchange-icon">Stack Exchange icon</title>
    <path
...
`;
export const visualstudiocodeIcon = html`
  <svg
    viewBox="0 0 24 24"
    width="24"
    height="24"
    aria-labelledby="visualstudiocode-icon"
    role="img"
  >
    <title id="visualstudiocode-icon">Visual Studio Code icon</title>
    <path
      d="M23.846 1.979L18.895 0 8.125 10.5 1.57 5.49l-1.424.705v11.64l1.41.69 6.555-4.995L18.906 24l4.948-1.949V1.995l-.012-.016h.004zM2.275 14.729V9.271l3.03 2.699-3.03 2.745v.014zm9.721-2.744L18.07 7.44v9.121l-6.074-4.576z"
    />
  </svg>
`;
