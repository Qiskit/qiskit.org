      ...
      <section class="colored">
        <div class="row limited-width">
          <div class="description">
            ...
            <p>${i18next.t('pages.ignis.aboutDescription')}</p>
            <h3>${i18next.t('pages.ignis.stackTitle')}</h3>
            <div class="stack-list">
              <div class="element">
                <div class="title">QuantumCircuits</div>
                <div class="subtitle">List of circuits generated by one if the ignis modules</div>
              </div>
              <div class="element">
          ...
          <div class="illustration">
            ...
            <code-sample type="bash">
              <template>
                [python3] $ pip install qiskit_ignis
              </template>
            </code-sample>
            ...
            <code-sample type="python" copy-clipboard-button>
              ...
              <template>
                ...
                import qiskit_ignis.randomized_benchmarking.standard_rb.randomizedbenchmarking
                as rb
                ...
                rbfit = rb_fitters.RBFitter(None, xdata, shots, rb_opts['rb_pattern'])
                ...
                print('After seed %d, EPC %f'%(rb_seed,rbfit.fit[0]['epc']))
              </template>
              <!-- htmlmin:ignore -->
            </code-sample>
          </div>
