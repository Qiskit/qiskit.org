...
<header>
  ...
  <div>
    <h1>
      ...
      <a href="https://pypi.python.org/pypi/qiskit" target="_blank" rel="noopener">
        <img src="https://img.shields.io/pypi/v/qiskit.svg" alt="Qiskit version badge"
             width="78px" height="20px">
      </a>
    </h1>
    <h2>${i18next.t('pages.home.headerSubTitle')}</h2>
    <div class="badges">
      <a href="https://github.com/Qiskit" target="_blank" rel="noopener" tabindex="-1">
        <vaadin-button theme="secondary small">${githubIcon} GitHub</vaadin-button>
      </a>
      <a href="https://join.slack.com/t/qiskit/shared_invite/enQtNDc2NjUzMjE4Mzc0LTMwZmE0YTM4ZThiNGJmODkzN2Y2NTNlMDIwYWNjYzA2ZmM1YTRlZGQ3OGM0NjcwMjZkZGE0MTA4MGQ1ZTVmYzk"
         target="_blank" rel="noopener" tabindex="-1">
        <vaadin-button theme="secondary small">${slackIcon}
          ${i18next.t('joinSlack')}</vaadin-button>
      </a>
    </div>
  </div>
</header>
...
<section class="colored">
  <div class="row limited-width">
    <div class="description">
      ...
      <div class="actions">
        <a href="https://mybinder.org/v2/gh/QISKit/qiskit-tutorial/master?filepath=index.ipynb"
           target="_blank" rel="noopener" tabindex="-1">
  ...
  <div class="row limited-width">
    ...
    <div class="illustration">
      <ul class="social-networks-list">
        <li>
          <a href="https://qiskit.slack.com" title="Slack community" target="_blank" rel="noopener">
            <div class="social-network">${slackIcon} <span class="name">Slack</span></div>
          </a>
        </li>
        <li>
          <a href="https://github.com/Qiskit" title="GitHub organization" target="_blank"
             rel="noopener">
            <div class="social-network">${githubIcon} <span class="name">GitHub</span></div>
          </a>
        </li>
        <li>
          <a href="https://quantumcomputing.stackexchange.com/search?q=qiskit" title="Stack Exchange community"
             target="_blank" rel="noopener">
            <div class="social-network">${stackexchangeIcon} <span class="name">Stack
                Exchange</span></div>
          </a>
        </li>
        <li>
          <a href="https://twitter.com/Qiskit" title="Twitter profile" target="_blank"
             rel="noopener">
            <div class="social-network">${twitterIcon} <span class="name">Twitter</span></div>
          </a>
        </li>
        <li>
          <a href="https://medium.com/Qiskit" title="Medium profile" target="_blank" rel="noopener">
            <div class="social-network">${mediumIcon} <span class="name">Medium</span></div>
          </a>
        </li>
        <li>
          <a href="https://www.youtube.com/Qiskit" title="YouTube channel" target="_blank"
             rel="noopener">
            <div class="social-network">${youtubeIcon} <span class="name">YouTube</span></div>
          </a>
        </li>
        <li>
          <a href="https://www.facebook.com/Qiskit" title="Facebook page" target="_blank"
             rel="noopener">
...
<section class="colored">
  <div class="row limited-width">
    <div class="description">
      ...
      <div class="actions">
        <a href="https://quantumexperience.ng.bluemix.net/qx/editor" title="IBM Q Experience"
           target="_blank" rel="noopener" tabindex="-1">
