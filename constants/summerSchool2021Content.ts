...
const header = {
  ...
  description: [
    ...
    'Registration will open on May 26, 2021 at 12:00 PM EST. Please follow <a target="_blank" style="cursor:pointer; text-decoration: none; color: #0f62fe;" href="https://twitter.com/Qiskit">Qiskit Twitter</a> for more details and updates. For any questions, please check out our FAQ or submit an enquiry using the form below!',
