<template>
  ...
  >
    <defs>
      ...
      >
        <stop class="logo__gradient" offset=".2" stop-opacity="0" />
        <stop class="logo__gradient" offset="1" />
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop class="logo__gradient" offset="0" stop-opacity="0" />
        <stop class="logo__gradient" offset="1" />
      </radialGradient>
      <radialGradient
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop class="logo__gradient" offset=".4" stop-opacity="0" />
        <stop class="logo__gradient" offset="1" />
      </radialGradient>
      <radialGradient
      ...
      >
        <stop class="logo__gradient" offset="0" stop-opacity="0" />
        <stop class="logo__gradient" offset=".4" />
      </radialGradient>
    </defs>
    <path
      class="logo__solid"
