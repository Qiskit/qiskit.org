<template>
  <div class="cds--row ui-filters-results-layout">
    ...
    <div
      class="cds--col-xlg-14 cds--col-lg-12 cds--col-md-6 ui-filters-results-layout__main-section"
    >
      <slot name="results" />
