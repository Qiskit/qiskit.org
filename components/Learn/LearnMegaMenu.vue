  ...
  content: [
    {
      ...
      url: `${baseUrl}${pathBasicsCourse}/single-systems`,
      segment: {
        cta: "single_systems",
        location: sectionBasicsCourse,
      },
    },
    {
      ...
      url: `${baseUrl}${pathBasicsCourse}/multiple-systems`,
      segment: {
        cta: "multiple_systems",
        location: sectionBasicsCourse,
      },
    },
    {
      label: "Quantum circuits",
      url: `${baseUrl}${pathBasicsCourse}/quantum-circuits`,
      segment: {
        cta: "quantum_circuits",
        location: sectionBasicsCourse,
      },
    },
    {
      label: "Entanglement in action",
      url: `${baseUrl}${pathBasicsCourse}/entanglement-in-action`,
      segment: {
...
const INTRODUCTION_COURSE: MegaDropdownMenuGroup = {
  title: {
    ...
    segment: {
      cta: wholeSection,
      location: sectionIntroductionCourse,
    },
  },
  content: [
    {
    ...
    },
    {
      ...
      segment: {
        cta: "describing-quantum-computers",
        location: sectionIntroductionCourse,
      },
    },
    {
...
const QML_COURSE: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "parameterized-quantum-circuits",
        location: sectionQMLCourse,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "variational-classification",
        location: sectionQMLCourse,
      },
    },
    {
      ...
      segment: {
        cta: "quantum-feature-maps-kernels",
        location: sectionQMLCourse,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "quantum-generative-adversarial-networks",
        location: sectionQMLCourse,
      },
    },
    {
...
const PREREQUISITES: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "python-and-jupyter-notebooks",
        location: sectionPrerequisites,
      },
    },
  ],
...
const QUANTUM_STATES_AND_QUBITS: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "the-case-for-quantum-computers",
        location: sectionQuantumStatesAndQubits,
      },
    },
  ],
...
const MULTIPLE_QUBITS_AND_ENTANGLEMENT: MegaDropdownMenuGroup = {
  title: {
    ...
    segment: {
      cta: wholeSection,
      location: sectionMultipleQubitsAndEntanglement,
    },
  },
  content: [
    {
...
const QUANTUM_PROTOCOLS_AND_ALGORITHMS: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "bernstein-vazirani-algorithm",
        location: sectionProtocolsAndAlgorithms,
      },
    },
    {
  ...
  content: [
    {
      ...
      segment: {
        cta: "calibrating-qubits-using-qiskit-pulse",
        location: sectionPulses,
      },
    },
    {
      ...
      segment: {
        cta: "accessing_higher_energy_states-with-qiskit-pulse",
        location: sectionPulses,
      },
    },
    {
      ...
      segment: {
        cta: "introduction-to-transmon-physics",
        location: sectionPulses,
      },
    },
    {
      ...
      segment: {
        cta: "circuit-quantum-electrodynamics",
        location: sectionPulses,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "measuring-the-qubit-ac-stark-shift",
        location: sectionPulses,
      },
    },
    {
  ...
  content: [
    {
      ...
      segment: {
        cta: "solving-linear-systems-of-equations-using-hhl-and-its-qiskit-implementation",
        location: sectionApps,
      },
    },
    {
      ...
      segment: {
        cta: "simulating-molecules-using-vqe",
        location: sectionApps,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "hybrid-quantum-classical-neural-networks-with-pytorch-and-qiskit",
        location: sectionApps,
      },
    },
    {
  ...
  content: [
    {
      ...
      segment: {
        cta: "introduction-to-quantum-error-correction-via-the-repetition-code",
        location: sectionCircuits,
      },
    },
    {
      ...
      segment: {
        cta: "measurement-error-mitigation",
        location: sectionCircuits,
      },
    },
    {
...
const QUANTUM_COMPUTING_LABS: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "lab-3-quantum-measurements",
        location: sectionLabs,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "lab-5-accuracy-of-quantum-phase-estimation",
        location: sectionLabs,
      },
    },
    {
      ...
      segment: {
        cta: "lab-6-iterative-phase-estimation-algorithm",
        location: sectionLabs,
      },
    },
    {
      ...
      segment: {
        cta: "lab-7-scalable-shors-algorithm",
        location: sectionLabs,
      },
    },
    {
      ...
      segment: {
        cta: "lab-8-grovers-search-with-an-unknown-number-of-solutions",
        location: sectionLabs,
      },
    },
    {
  ...
  content: [
    {
      ...
      segment: {
        cta: "single_systems_problem_set",
        location: sectionProblemSets,
      },
    },
    {
      ...
      segment: {
        cta: "quantum_enigma_problem_set",
        location: sectionProblemSets,
      },
    },
  ],
...
const QUANTUM_CIRCUITS: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "1_getting_started_with_qiskit",
        location: sectionTutorials,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "3_summary_of_quantum_operations",
        location: sectionTutorials,
      },
    },
    {
...
const ADVANCED_CIRCUITS: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "03_advanced_circuit_visualization",
        location: sectionTutorials,
      },
    },
    {
      ...
      segment: {
        cta: "04_transpiler_passes_and_passmanager",
        location: sectionTutorials,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "06_building_pulse_schedules",
        location: sectionTutorials,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "08_gathering_system_information",
        location: sectionTutorials,
      },
    },
    {
      ...
      segment: {
        cta: "advanced_circuit_tutorials",
        location: sectionTutorials,
      },
    },
  ],
...
const CLASSICAL_SIMULATORS: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "6_extended_stabilizer_tutorial",
        location: sectionTutorials,
      },
    },
    {
      ...
      segment: {
        cta: "7_matrix_product_state_method",
        location: sectionTutorials,
      },
    },
    {
      ...
      segment: {
        cta: "high_performance_simulator_tutorials",
        location: sectionTutorials,
      },
    },
  ],
  ...
  content: [
    {
      ...
      segment: {
        cta: "01_algorithms_introduction",
        location: sectionTutorials,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "03_vqe_simulation_with_noise",
        location: sectionTutorials,
      },
    },
    {
...
const SAMPLE_ALGORITHMS_IN_QISKIT: MegaDropdownMenuGroup = {
  ...
  content: [
    ...
    },
    {
      ...
      segment: {
        cta: "textbook-algorithms-in-qiskit",
        location: sectionTutorials,
      },
    },
  ],
  ...
  content: [
    {
      ...
      segment: {
        cta: "qubits-states-circuits-measurements",
        location: sectionSummerSchool,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "shors-algorithm-i-fourier-transform-phase-estimation",
        location: sectionSummerSchool,
      },
    },
    {
      label:
        "Shor's Algorithm II From Factoring to Period-Finding, Writing the Quantum Program",
      url: `${baseUrl}${pathSummerSchool}/2020/shors-algorithm-ii-from-factoring-to-period-finding-writing-program`,
      segment: {
        cta: "shors-algorithm-ii-from-factoring-to-period-finding-writing-program",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "error-correction-using-repetition-codes",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "superconducting-qubits-i-quantizingharmonic-oscillator-josephson-junctions",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "superconducting-qubits-ii-circuit-electrodynamics-readout-calibration-methods",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "chemistry-i-obtaining-qubit-hamiltonian-h2-lih",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "chemistry-ii-finding-ground-states-h2-lih",
        location: sectionSummerSchool,
      },
    },
    {
  ...
  content: [
    {
      ...
      segment: {
        cta: "lec1-1-vector-spaces-tensor-products-qubits",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec1-2-introduction-quantum-circuits",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec2-1-simple-quantum-algorithms-i",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec2-2-simple-quantum-algorithms-ii",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec3-1-noise-quantum-computers-1",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec3-2-noise-quantum-computers-pt-2",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lab1-quantum-computing-algorithm-operations",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec4-1-introduction-classical-machine-learning",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec4-2-advanced-classical-machine-learning",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec5-1-building-quantum-classifier",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec5-2-introduction-quantum-approximate-optimization-algorithm-applications",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lab2-variational-algorithms",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec6-1-from-variational-classifiers-linear-classifiers",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec6-2-quantum-feature-spaces-kernels",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec7-1-quantum-kernels-practice",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lab3-introduction-quantum-kernels-support-vector-machines",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec8-1-introduction-applications-quantum-models",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec8-2-barren-plateaus-trainability-issues-how-avoid-them",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lab4-introduction-training-quantum-circuits",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec9-1-introduction-quantum-hardware",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec9-2-hardware-efficient-ansatze-quantum-machine-learning",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lab5-introduction-hardware-efficient-ansatze-quantum-machine-learning",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec10-1-advanced-qml-algorithms",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "lec10-2-the-capacity-power-quantum-machine-learning-models-future-quantum-machine-learning",
        location: sectionSummerSchool,
      },
    },
  ],
  ...
  content: [
    {
      ...
      segment: {
        cta: "history-quantum-computing-motivation-quantum-simulation",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "introduction-linear-algebra-prerequisite-mathematics-circuit-composition",
        location: sectionSummerSchool,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "hamiltonian-time-evolution",
        location: sectionSummerSchool,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "noisy-real-hardware-noise-quantum-computers",
        location: sectionSummerSchool,
      },
    },
    {
      ...
      segment: {
        cta: "broad-overview-quantum-chemistry-simulation-why-is-challenge",
        location: sectionSummerSchool,
      },
    },
    {
    ...
    },
    {
      ...
      segment: {
        cta: "methods-quantum-simulation",
        location: sectionSummerSchool,
      },
    },
    {
