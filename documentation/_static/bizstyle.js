...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("QISKit SDK 0.3.5 documentation");
        $("div.related:last  ul li:not(.right):first a").text("QISKit SDK 0.3.5 documentation");
    }
});