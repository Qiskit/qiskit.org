...
// The collaborators are arranged alphabetically
...
export const collaborators = [
  ...
  {
    name: 'Christophe Vuillot',
    institution: 'QuTech institute at TU Delft',
    url: 'https://qutech.nl/person/christopher-vuillot/',
  },
  {
    name: 'Damian Steiger',
    institution: 'ETH Zurich / ProjectQ',
    url: 'http://www.projectq.ch',
  },
  {
    name: 'Enrique Solano',
    institution: 'University of the Basque Country and Shanghai University',
  ...
  {
    name: 'Miguel Ángel Martín-Delgado',
